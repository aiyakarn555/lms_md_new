...
class GrouptestingOnlineController extends Controller
{
    ...
    {
    	$model=new GrouptestingOnline;

    	if(isset($_POST['GrouptestingOnline']))
    	{
    		$model->attributes=$_POST['GrouptestingOnline'];
    ...
    {
    	$model=new GrouptestingOnline('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GrouptestingOnline']))
			$model->attributes=$_GET['GrouptestingOnline'];
    ...
    public function actionOnchangeList(){
        // var_dump($_POST);
        $lessonList = LessonOnline::model()->findAll(array("condition"=>"active = 'y' and lang_id = ".$_POST['lang_id'],'order'=>'id'));
