...
class Certificate extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('sign_id2,cert_type', 'required'),
			// array('sign_id2', 'required'),
			array('sign_id , sign_id2, cert_hide, cert_type,cert_hour, cert_display, create_by, update_by', 'numerical', 'integerOnly'=>true),
			array('cert_number', 'length', 'max'=>100),
			array('cert_name', 'length', 'max'=>250),
			array('active', 'length', 'max'=>1),
			array('cert_background,cert_type, create_date, update_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('cert_id, sign_id,cert_type, sign_id2 , cert_course_number, cert_number,cert_name, cert_background, cert_hide, cert_hour, cert_display, create_date, create_by, update_date, update_by, active, cert_text', 'safe', 'on'=>'search'),
		);
	}
