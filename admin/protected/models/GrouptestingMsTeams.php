 ...
 */
class GrouptestingMsTeams extends CActiveRecord
{
	...
	{
		$dataManage = new CActiveDataProvider('ManageMsTeams',array(
			'criteria'=>array(
	    ...
	    $Clients = GrouptestingMsTeams::model()->findAll($criteria);
