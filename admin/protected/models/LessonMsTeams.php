...
class LessonMsTeams extends CActiveRecord
{
    ...
    public function scopes()
    {
        ...
        $Access = Controller::SetAccess( array("LessonMsTeams.*") );
...
public static function getChilds($sequence_id)
{
    ...
    $lessonList = LessonMsTeams::model()->findAll($criteria);
    ...
    foreach($lessonList as $model) {
        ...
        $row['lesson'] = $model->id;
        $row['code'] = $model->id;
        $row['children'] = LessonMsTeams::getChilds($model->id);
        $data[] = $row;
    }
    return $data;
}
...
public function search()
{
    ...
    $criteria->compare('msteams.type_ms_teams',1);
        // $criteria->order = 'id';
