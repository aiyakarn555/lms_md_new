...
/**
 * This is the model class for table "{{manage_ms_teams}}".
 *
 * The followings are the available columns in table '{{manage_ms_teams}}':
 ...
 */
class ManageMsTeamsInstitution extends CActiveRecord
{
	public $titleShow;
	public $stepShow;
	...
	{
		return QuestionMsTeams::model()->count(new CDbCriteria(array(
	...
	public function search($id=null)
	{
		...
		if(null !== Yii::app()->user && isset(Yii::app()->user->id)){
			...
			if($User){
				...
				$criteria->addInCondition('manage.create_by',$user_array);

			}
		}else{
			$criteria->compare('manage.create_by',$this->create_by);
		}
