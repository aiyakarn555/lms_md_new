...
/**
 * This is the model class for table "{{manage_online}}".
 *
 * The followings are the available columns in table '{{manage_online}}':
 ...
 */
class ManageOnline extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'group' => array(self::BELONGS_TO, 'GrouptestingOnline', 'group_id'),
		);
	}

	public function getCount()
	{
		return QuestionOnline::model()->count(new CDbCriteria(array(
	...
	public function search($id=null)
	{
		...
		if (!in_array(1, $group)){
			...
			$criteria->addInCondition('manage.create_by', $groupUser);	
		}
