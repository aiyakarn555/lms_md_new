...
class MsOnline extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('detail_ms_teams,url_join_meeting, start_date, end_date, create_date, update_date , ms_price, price, face_verify', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name_ms_teams,url_join_meeting, detail_ms_teams, start_date, end_date, active, create_by, create_date, update_date, update_by, ms_price, price, face_verify', 'safe', 'on'=>'search'),
		);
	}
