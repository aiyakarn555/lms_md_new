 ...
 *
 * The followings are the available columns in table '{{org_country}}':
 * @property integer $id
 ...
 * @property OrgCountryCompany[] $orgCountryCompanies
 */
class OrgCountry extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'orgCountryCompanies' => array(self::HAS_MANY, 'OrgCountryCompany', 'country_id'),
	 ...
	 * @return OrgCountry the static model class
	 */
