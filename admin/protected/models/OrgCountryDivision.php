...
/**
 * This is the model class for table "{{org_country_division}}".
 *
 * The followings are the available columns in table '{{org_country_division}}':
 * @property integer $id
 ...
 */
class OrgCountryDivision extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'department' => array(self::BELONGS_TO, 'OrgCountryDepartment', 'department_id'),
	 ...
	 * @return OrgCountryDivision the static model class
	 */
