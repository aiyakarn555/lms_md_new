...
/**
 * This is the model class for table "{{org_country_team}}".
 *
 * The followings are the available columns in table '{{org_country_team}}':
 * @property integer $id
 ...
 */
class OrgCountryTeam extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'section' => array(self::BELONGS_TO, 'OrgCountrySection', 'section_id'),
	 ...
	 * @return OrgCountryTeam the static model class
	 */
