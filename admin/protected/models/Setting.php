...
class Setting extends AActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('settings_intro_detail, settings_score, settings_register, settings_confirmmail, settings_intro_bg_color, settings_institution, settings_email, settings_tel, settings_line, settings_register_office, settings_register_personal,settings_confirmface,settings_confirmface_zoom', 'safe'),
			array('setting_id, settings_score, settings_user_email, settings_register, settings_confirmmail, settings_pass_email, settings_testing, settings_intro_status, settings_intro_detail, settings_intro_bg_color, settings_institution, settings_email, settings_tel, settings_line, settings_register_office, settings_register_personal,settings_confirmface,settings_confirmface_zoom', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'settings_confirmface' => 'เปิด-ปิด การลงทะเบียนใบหน้า',
			'settings_confirmface_zoom' => 'เปิด-ปิด การยืนยันใบหน้าบนเว็บฯ ขา ZOOM',
