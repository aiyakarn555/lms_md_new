<?php
$titleName = 'จัดการภาพแคปหน้าจอผู้เรียน';
           ...
           <div class="innerLR">
            ...
            <div class="widget" style="margin-top: -1px;">
                ...
                <div class="widget-body capscreen-card">
                    <h5> ห้องเรียนรู้ด้วยตัวเอง :<strong class="text-primary"> <?= $Courses->course_title ?></strong></h5>
                    <div class="panel panel-info panel-capture">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <h5 class="panel-item">
                                        เลขบัตรประชาชน<br>
                                        <strong><?= $Profiles->identification ?></strong>
                                    </h5>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <h5 class="panel-item">
                                        ชื่อ นามสกุล<br>
                                        <strong><?= $Profiles->firstname. " " .$Profiles->lastname ?></strong>
                                    </h5>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <h5 class="panel-item">
                        ...
                        if (file_exists(YiiBase::getPathOfAlias('webroot') . '/../uploads/FaceRegis/' . $Profiles->user_id.'.jpg')) {
                            $srcUser = Yii::app()->baseUrl.'/../uploads/FaceRegis/'.$Profiles->user_id.'.jpg';
                        }else{
                            if(file_exists(YiiBase::getPathOfAlias('webroot') . '/../../../uploads/FaceRegis/' . $Profiles->user_id.'.jpg')){
                                $srcUser = Yii::app()->theme->baseUrl . '/../../../uploads/FaceRegis/' .$Profiles->user_id.'.jpg';
                            }else{
                                $srcUser = "<div align='center'>-</div>";
                            }
                        }

                        if (file_exists(YiiBase::getPathOfAlias('webroot') . '/../uploads/IdCard/' . $Profiles->user_id.'.jpg')) {
                            $srcIdCard = Yii::app()->baseUrl.'/../uploads/IdCard/'.$Profiles->user_id.'.jpg';
                        }else{
                            if(file_exists(YiiBase::getPathOfAlias('webroot') . '/../../../uploads/IdCard/' . $Profiles->user_id.'.jpg')){
                                $srcIdCard = Yii::app()->theme->baseUrl . '/../../../uploads/IdCard/' .$Profiles->user_id.'.jpg';
                            }else{
                                    ...
                                    <?php foreach ($model as $key => $val) { ?>
                                        ...
                                        <?php if($src != ""){ ?>
                                            ...
                                            <div class="col-sm-3 col-xs-5">
                                                <img src="<?=$src?>">
                                                <div class="img-date">
                                                    <p class="mt-1"><b>รูปที่ <?= $key+1 ?></b> วันที่ <?= explode(" ",$val->create_date)[0] ?></p>
