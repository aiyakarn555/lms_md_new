...
if($model['certType'] == 1){ ?>
 ...
 <div style=" position:absolute; top: 175mm;right: -26mm;">
   <div class="b size18" style="max-width: 700px" >
...
<div style="position:absolute; top: 214mm; left: -87mm;">
    <img style="width: 135px;height: 180px;object-fit: contain;" src="<?php echo Yii::app()->basePath."/../../themes/template2/images/thumbnail-profile.png"; ?>" >
</div>
...
<div style="position:absolute; top: 206mm; left: 22.5mm;">
    <img style="width: 100px;" src="<?php echo Yii::app()->basePath."/../../uploads/signature/".$model['renderSign2']; ?>" >
</div>

<div style="position:absolute; top: 188mm; left: -77mm;">
    <img style="width: 130px;" src="<?php echo Yii::app()->basePath."/../../themes/template2/images/thumbnail-profile.png"; ?>" >
</div>
