        ...
        <div class="widget-body">
            <div class="form">
                ...
                <div class="row">
                    ...
                    <?php echo $form->textField($model, 'email', array('size' => 60, 'maxlength' => 250, 'class' => 'span3')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($model, 'email'); ?>
                </div>
                <div class="row">
                    <?php echo $form->labelEx($model, 'password'); ?>
                    <?php echo $form->passwordField($model, 'password', array('size' => 60, 'maxlength' => 250, 'class' => 'span3')); ?>
                    <?php echo $this->NotEmpty(); ?>
