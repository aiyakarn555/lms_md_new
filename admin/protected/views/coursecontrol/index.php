...
<div class="span12">
<h1>Org Courses: <u><?= $orgchart->title ?></u></h1>
...
<div class="span12">
	<menu id="nestable-menu">
        ...
        ?>
           ...
           <!--   <?php
            if($_GET['courseType']==2) {
            ?>
                <a href="<?= Yii::app()->createUrl('Coursecontrol/index/id/'. $_GET['id'], array('courseType' => 1)); ?>"><button type="button" class="btn btn-danger pull-right" style="margin-right:5px;">หลักสูตรบังคับ</button></a> 
            <?php
            } else {
            ?>
                <a href="<?= Yii::app()->createUrl('Coursecontrol/index/id/'. $_GET['id'], array('courseType' => 2)); ?>"><button type="button" class="btn btn-danger pull-right" style="margin-right:5px;">หลักสูตรเลือก</button></a> 
            <?php
            } 
            ?> -->
    </menu>
...
<div class="row-fluid">
  ...
  <div class="dd" id="nestable">
    ...
    $courseonline=OrgCourse::model()->with('courses')->find(array(
        'condition'=>'orgcourse.parent_id=0 AND courseonline.active="y" AND orgcourse.orgchart_id='.$_GET['id'],
        ));
  ...
  <div class="dd" id="nestable2">
                ...
                <ol class="dd-list">
            			...
            			foreach ($courseonline as $key => $value) {
                            if( $value->course_type == $course_type) {
            				?>
							 <li class="dd-item" data-id="<?=$value->course_id?>">
							    <div class="dd-handle"><?=$value->course_title.$value->course_type?></div>
							 </li>
            				<?php
                            }
            			}
