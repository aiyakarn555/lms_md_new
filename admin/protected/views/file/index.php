			...
			<div class="separator bottom form-inline small">
				<span class="pull-left" style="margin-left: 10px;">
					<a class="btn btn-primary btn-icon glyphicons circle_plus"
					   href="<?php echo Yii::app()->createUrl("/File/create",array("id"=>$id))?>"><i></i> เพิ่มวิดีโอ</a>
                </span>
				        ...
				        array(
							...
							'value' => function($val) {
								...
								foreach ($lang as $key => $value) {
									...
									if ($menu_lesson) {
										$str = ' (เพิ่ม)';
										$link = array("/File/create","lang_id"=>$value->id,"parent_id"=>$val->id);
										$class = "btn btn-icon";
										if($menu){
											$id = $menu ? $menu->id : $val->id;
											$str = ' (แก้ไข)';
											$class = "btn btn-success btn-icon";
											$link = array("/File/update","id"=>$id,"lang_id"=>$value->id,"parent_id"=>$val->id);
										}
