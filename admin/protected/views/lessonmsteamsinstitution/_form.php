...
<script type="text/javascript">
    ...
    function deleteFileDoc(filedoc_id,file_id){
        $.get("<?php echo $this->createUrl('LessonMsTeamsInstitution/deleteFileDoc'); ?>",{id:file_id},function(data){
            if($.trim(data)==1){
    ...
    function editName(filedoc_id){
        ...
        $.get("<?php echo $this->createUrl('LessonMsTeamsInstitution/editName'); ?>",{id:filedoc_id,name:name},function(data){
                ...
                <div class="form">
                   ...
                   <?php $form=$this->beginWidget('AActiveForm', array(
                    ...
                    'htmlOptions' => array('enctype' => 'multipart/form-data')
                        ...
                        // if($check_user){
                        //     // $institution_id = $check_user->institution_id;
                        ...
                        $lesson = LessonMsTeamsInstitution::model()->FindByPk($parent_id);
                        $rootLesson = $lesson;
                    ...
                    $(function() {
                        $('#doc').uploadifive({
                            'auto'             : false,
                                    ...
                                    'queueID'          : 'docqueue',
                                    'uploadScript'     : '<?php echo $this->createUrl("LessonMsTeamsInstitution/uploadifivedoc"); ?>',
