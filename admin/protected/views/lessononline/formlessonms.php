	...
	<div class="widget widget-tabs border-bottom-none">
		...
		<div class="widget-body">
			...
			<div class="row">
				...
				<?php echo $this->listGroupLessonOnline($Manage,$model->id,'span8');?>
							...
							'buttons' => array(
								...
								'update'=> array( 
									...
									'url'=>function ($model) use ($type) {
							                return Yii::app()->createUrl("/lessonOnline/UpdateLessonMs", array("id"=>$model->manage_id,"type"=>$type));
								...
								'delete'=> array( 
									'visible'=>'true',
									'url'=>'$this->grid->controller->createUrl("/manage/deleteonline", array("id"=>"$data->manage_id"))', 
								),
							),
