			...
			<div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <label><h4>เปอร์เซ็นการผ่าน : <span><?= $model->percen_test." %" ?></span></h4></label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 text-center">
                         <?php 
                            $modelScoreExam = Coursescore::model()->find(array(
                           ...
                           $logQuesExam = Courselogques::model()->findAll(array(
                            ...
                            foreach ($logQuesExam as $key => $value) {
                                ...
                                $answerQuestionExam = Coursechoice::model()->findAll(array(
                ...
                <input type="hidden" name="statusPass" id="statusPass" value="<?= number_format((float)(($scoreExam/$totalScoreExam)*100), 2, '.', '') >= $model->percen_test  ? 'y': 'n'?>"/>
                                ...
                                <?php   
                                  ...
                                  $modelScore = Coursescore::model()->find(array(
                                    ...
                                    foreach ($logQues as $key => $value) {
                                        ...
                                        $answer = Courselogchoice::model()->findAll(array( 
                                        ...
                                        $answerQuestion = Coursechoice::model()->findAll(array(
                                            'condition'=>"ques_id=:ques_id and choice_answer='1'",
                                            'params' => array(':ques_id' => $value->ques_id)
                                        ));
                                        ...
                                        foreach($answer as $key => $ans) {
                                            $answerUser = $ans->choices->choice_id;
                                        }
                ...
                <div class="container-fluid">
                    <div class="row buttons">
                        <span style="display: inline;">
                                <?=  CHtml::link("<i></i> ย้อนกลับ",array("/manageExamResult/ManageCourse",
                                        "type_cou"=>$type_cou,
                                        "course_id"=>$course_id,
                                        "gen_id"=>$gen_id,
...
<script>
    ...
    var percentPass = <?= $model->percen_test ?>;
    var arrCheck = [];
