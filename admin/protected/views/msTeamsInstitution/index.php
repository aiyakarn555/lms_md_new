...
<?php
$titleName = 'ห้องเรียนรู้ทางไกล(สถาบัน)';
$formNameModel = 'MsTeamsInstitution';
				...
				<?php $this->widget('AGridView', array(
					...
					'columns'=>array(
						...
						array(
							...
							'value'=>function($data){
								$modelImage = MsTeams::model()->findByPk($data->id);
	                            return Controller::ImageShowIndex($modelImage,$modelImage->ms_teams_picture);
	                        },
						...
						array(
							'header'=>'Link ห้องเรียนรู้ทางไกล',
							'type'=>'raw',
