...
// $create_by = Profile::model()->findByPk($model->create_by);
// $model->create_by = $create_by->firstname ; 
// $update_by = Profile::model()->findByPk($model->update_by);
// $model->update_by = $update_by->firstname ; 
