				...
				<?php $this->widget('AGridView', array(
					...
					'columns'=>array(
						...
						array(
							'type'=>'raw',
							'value'=>function($data){
								if($data->recommended_status == 0){
									return CHtml::link("ปิด",array("/vdo/active","id"=>$data->vdo_id), array("class"=>"btn btn-danger"));
								} else {
									return CHtml::link("เปิด",array("/vdo/active","id"=>$data->vdo_id), array("class"=>"btn btn-success"));
								}
							},
							'header' => 'เปิด/ปิด Recommended',
