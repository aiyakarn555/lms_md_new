...
/**
 * This is the model class for table "{{capture_exams_teams}}".
 *
 * The followings are the available columns in table '{{capture_exams_teams}}':
 * @property integer $id
 ...
 */
class CaptureExamsTeams extends CActiveRecord
{
	/**
	 ...
	 * @return CaptureExamsTeams the static model class
	 */
