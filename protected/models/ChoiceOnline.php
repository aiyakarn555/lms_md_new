...
/**
 * This is the model class for table "{{choice_online}}".
 *
 * The followings are the available columns in table '{{choice_online}}':
 ...
 * @property QuestionOnline $ques
 */
class ChoiceOnline extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'question' => array(self::BELONGS_TO, 'QuestionOnline', 'ques_id'),
		);
	}
