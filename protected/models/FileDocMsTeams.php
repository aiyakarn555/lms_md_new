...
/**
 * This is the model class for table "{{file_doc_ms_teams}}".
 *
 * The followings are the available columns in table '{{file_doc_ms_teams}}':
 * @property integer $id
 ...
 */
class FileDocMsTeams extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('lesson_teams_id, file_position, create_by, update_by', 'numerical', 'integerOnly'=>true),
			...
			array('id, lesson_teams_id, file_name, filename, length, file_position, create_date, create_by, update_date, update_by, active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		...
		return array(
			'lesson_teams_id' => 'บทเรียนออนไลน์',
			'filename' => 'ไฟล์ประกอบบทเรียน (pdf,doc,docx,ppt,pptx,xls,xlsx)',
			'file_name' => 'ไฟล์ประกอบบทเรียน',
			'pp_file' => 'ไฟล์ สไลด์ Powerpoint (pptx)',
			'doc' => 'ไฟล์ประกอบบทเรียน (pdf,doc,docx,ppt,pptx,xls,xlsx)',
			'length' => 'Length',
	...
	public function search($id = null)
	{
		...
		$criteria=new CDbCriteria;
			...
			if($id !== null)
		{
			$criteria->compare('lesson_teams_id',$id);
		}
		else
		{
			$criteria->compare('lesson_teams_id',$this->lesson_id);
		}
	 ...
	 * @return FileDocMsTeams the static model class
	 */
