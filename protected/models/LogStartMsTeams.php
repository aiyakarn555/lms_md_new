...
/**
 * This is the model class for table "{{log_start_ms_teams}}".
 *
 * The followings are the available columns in table '{{log_start_ms_teams}}':
 * @property integer $id
 ...
 */
class LogStartMsTeams extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('user_id, ms_teams_id, create_by, update_by', 'numerical', 'integerOnly'=>true),
			array('active', 'length', 'max'=>1),
			array('start_date, create_date, update_date, end_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, ms_teams_id, start_date, create_date, create_by, update_date, update_by, active, end_date, gen_id', 'safe', 'on'=>'search'),
		);
	}
