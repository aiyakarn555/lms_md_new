...
/**
 * This is the model class for table "{{logques_online}}".
 *
 * The followings are the available columns in table '{{logques_online}}':
 ...
 * @property LessonOnline $lessonTeams
 */
class LogquesOnline extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            'questions'=>array(self::BELONGS_TO, 'QuestionOnline', 'ques_id'),
        );
    }
