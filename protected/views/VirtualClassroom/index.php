    ...
    <div class="container-main">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-main">
                ...
                <li class="breadcrumb-item active"><a style="color: #757272" href="<?php echo $this->createUrl('/virtualclassroom/index'); ?>"><?= $langId == 1 ? "Classroom Online" : "เรียนรู้ทางไกล (Online)" ?> </a> </li>
            </ol>
        </nav>
        <div class="content-main">

             <section class="search-filter">
                <form class="form row" enctype="multipart/form-data" id="vdo-form" action="<?php echo $this->createUrl('/virtualclassroom/index'); ?>" method="post"> 
            ...
            <section class="all-course">
                <div class="wrap-title-content">
                    <h3 class=""><?= $langId == 1 ? "All online classrooms" : "ห้องเรียน เรียนรู้ทางไกล (Online) ทั้งหมด" ?></h3>
                        ...
                        ?>
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                              ...
                              if(date("Y-m-d H:i:s") >= $recommend->start_date){ ?>
                                ...
                                <?php }else{ ?>
                                   <a class="card-course" href="javascript:void(0)" OnClick="alertCoursedate()">
                                   <?php } ?>
