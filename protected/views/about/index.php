    ...
    <div class="container-main">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-main">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?= $txtShow["Contactus"] ?></li>
            </ol>
        </nav>
                ...
                <div class="row mb-4 mt-3 ">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="google-map mt-0 mb-3" >
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.8469452376435!2d100.59897497567233!3d13.667069099248403!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e2a014f12c43b5%3A0x1c9c06f36892e751!2z4LmC4Lij4LiH4LmA4Lij4Li14Lii4LiZ4Liq4Li44Lig4Liy4Lie4Lia4Li44Lij4Li44Lip4LmA4LiU4Li04LiZ4LmA4Lij4Li34Lit!5e0!3m2!1sth!2sth!4v1725027739591!5m2!1sth!2sth" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>

                    </div>
                    <div class="col-lg-6 px-0 card-right-contact">
                        <h3 class="mb-3"><?= $about_data['about_title'] ?></h3>
                        <div class="row card-body mt-2">
                            ...
                            <div class="col-lg-10 col-xs-12">
                                ...
                                <!--<p><?= $about_data['about_tel'];  ?> (เจ้าหน้าที่ฝ่ายบริการ)</p> -->
								<p>081-2007000 </p>
                            </div>
                            ...
                            <div class="col-lg-10 col-xs-12">
                                ...
                                <p><?= $about_data['about_email'] ?></p>
                            </div>
                            <div class="col-lg-2 col-xs-12">
                            </div>
                            <div class="col-lg-10 col-xs-12">
                                <?= $about_data['about_detail'] ?></p>
                            </div>
                        </div>
                    </div>
                </div>
