	...
	<div class="col-sm-8">
		<form id="question-form" action="#" method="POST" role="form" onSubmit="return false">
			...
			<div class="text-center">
				<?php echo CHtml::tag('button', array('class' => 'submit btn btn-info btn-lg','onclick'=>'save_ans("previous")'),  empty(Yii::app()->session['lang']) || Yii::app()->session['lang'] == 1 ? 'Previous' : 'ก่อน'); ?>
				<?php echo CHtml::tag('button', array('class' => 'submit btn btn-info btn-lg','onclick'=>'save_ans("next")'), empty(Yii::app()->session['lang']) || Yii::app()->session['lang'] == 1 ? 'Next' : 'ถัดไป'); ?>
