...
<header id="header" class="main-header fixed-header">
    ...
    <nav class="navbar navbar-inverse" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <!-- < ?php
                if (empty(Yii::app()->session['lang']) || Yii::app()->session['lang'] == 2) {
                    $langId = Yii::app()->session['lang'] = 2;
                } else {
                ...
                <div class="menu-header">
                    ...
                    <?php if (Yii::app()->user->id == null) { ?>
                        <div>
                            ...
                            <span class="d-none d-sm-inline"> <?= $label->label_header_login_external ?></span></a></d>
                        <a class="btn-login " data-toggle="modal" href='https://login.microsoftonline.com/common/oauth2/authorize?client_id=2240fcc5-2667-4335-baff-3c8ebd602f1b&scope=openid+offline_access+group.read.all&redirect_uri=https://learn.ascendcorp.com/site/auth&response_type=code'>
                            <span class="d-none d-sm-inline"> <?= $label->label_header_login_internal ?></span></a></d> -->
                        <?php } else { ?>
                            <div class="dropdown user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <?php if (Yii::app()->user->id !== null) { ?>
                                        ...
                                        <li>
                                            <?php $url = Yii::app()->createUrl('video/library'); ?>

                                            <a href="<?= $url ?>"><i class="fas fa-list-ul"></i><?= $library ?></a>
                                        </li>
                                        <li>
                                            <?php $url = Yii::app()->createUrl('document'); ?>

                                            <a href="<?= $url ?>"><i class="fas fa-list-ul"></i><?= $document ?></a>
                                        </li>
                                        <li>
                                            <?php $url = Yii::app()->createUrl('course/index'); ?>

                                            <a href="<?= $url ?>"><i class="fas fa-list-ul"></i><?= $course ?></a>
                                        </li>
                                        <li>
                                            <?php $url = Yii::app()->createUrl('course/courseplan'); ?>

                                            <a href="<?= $url ?>"><i class="fas fa-list-ul"></i><?= $plan ?></a>
                                        </li>
                                    <?php } ?>
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="text-danger log-out" onclick="logout(<?php echo $user->type_register; ?>)"><i class="fas fa-sign-out-alt"></i><?= $label->label_header_logout ?></a>
                                    </li>
                                </ul>
                            </div>
                        <?php } ?>
    ...
    <nav class="collapse navbar-collapse navbar-ex1-collapse sidebar-left" role="navigation">
        <div class="menu-nano">
            <ul class="nav menu-active">
                <li class="active"><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-home"></i> Home</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-book-open"></i> หลักสูตร</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-book"></i> e-Library</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-file-download"></i> เอกสารดาวน์โหลด</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-play-circle"></i> วีดีโอแนะนำ</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-newspaper"></i> ข่าวประชาสัมพันธ์</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-comments"></i> คำถามที่พบบ่อย</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-exclamation-circle"></i></i> วิธีการใช้งาน</a></li>
                <li class=""><a href="<?php echo $this->createUrl('/site/index'); ?>" class=""><i class="fas fa-phone-alt"></i> ติดต่อเรา</a></li>
                        ...
                        if ($controller[0] != "registration" && $controller[0] != "privatemessage" && $controller[0] != "search" && $controller[0] != "forgot_password" && $controller[0] != "question" && $controller[0] != "virtualclassroom" && $controller[0] != "video") {
                            ...
                            if ($controller[0] != "webboard") {
                                if ($controller[0] == "course" && Yii::app()->user->id == null) {
                                    echo '<li class="' . $clss . '">
                                    <a data-toggle="modal" class="btn-login-course" href="https://login.microsoftonline.com/common/oauth2/authorize?client_id=2240fcc5-2667-4335-baff-3c8ebd602f1b&scope=openid+offline_access+group.read.all&redirect_uri=https://learn.ascendcorp.com/site/auth&response_type=code" >' . $value->title . '</span></a></li>';
                                } else {
                                    echo '<li class="' . $clss . '">
...
<script>
    ...
    function logout($type) {
        ...
        window.location.href = "<?= $this->createUrl('login/logout?type='); ?>" + $type;
    }
</script>
<script>
    startApp();
        ...
        <div class="modal-content">
            <form action="<?php echo $this->createUrl('login/index') ?>" method="POST" role="form" name='loginform'>
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-lock" aria-hidden="true"></i> <?= $label->label_header_login_internal ?></h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" autocomplete="off" placeholder='<?= $label->label_header_username ?>' name="UserLogin[username]" value="<?php echo Yii::app()->request->cookies['cookie_name']->value; ?>" required>
                            </div>

                            <div class="form-group">
                                <label for=""><?= $label->label_header_password ?></label>
                                <input type="password" class="form-control" autocomplete="off" placeholder='<?= $label->label_header_password ?>' name="UserLogin[password]" required>
                            </div>
